...
/**
	...
	* @detail 引用方式：,```JavaScript,var encoding = require('encoding');,var msgpack = encoding.msgpack;,```,或者,```JavaScript,var msgpack = require('msgpack');,```
	*/
declare module "msgpack" {
	...
	module msgpack {
		 ...
		 * 
		 */
		export function encode(data: any): Class_Buffer;
		 ...
		 * 
		 */
		export function decode(data: Class_Buffer): any;

	} /** end of `module msgpack` */
	export = msgpack
}
