...
if (mac) {
  ...
  // ./build debug && ./bin/Darwin_amd64_debug/fibjs test/gui_test.js
  describe('gui', () => {
      it('webview', () => {
...
if (win) {
  ...
  describe('gui', () => {
    ...
    it('log', () => {
      var p = process.open(
          process.execPath, [path.join(__dirname, 'gui_files', 'gui1.js')]);
      var r = p.readLines();
    ...
    it('debug', () => {
      var p = process.open(
          process.execPath, [path.join(__dirname, 'gui_files', 'gui2.js')]);
      var r = p.readLines();
